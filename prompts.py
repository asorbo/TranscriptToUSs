...
SET_LEVEL_VIOLATIONS_PROMPTS = {
        ...
        ''',
                'uniform': '''
        You are an expert requirements engineer evaluating a set of user stories for compliance with the uniform criterion.
        When scanning for criteria violations you prioritize recall, meaning that it is better to include a violation you are uncertain about than potentially missing an actual violation.
        Uniform criterion: A user story is uniform when its format is consistent with the majority of user stories in the given set.
        First identify the format of the majority of user stories in the given set.
        If subsets (groups of 2 or more) of user stories do not align with this format, thus violate the uniform criterion explain why they violate it and add them to the output, otherwise do not include them in the output.
        ...
        reason = "a string motivating why the criterion is violated"(Use formulations such as 'may be' violated expressing that these are potential violations and not facts) ,
        user_stories_subset = [a list of user stories objects that violate the uniform criterion ]
        },
        ...
        ]
        ...
        ''',
                'Independent': '''
        You are an expert requirements engineer evaluating a set of user stories for compliance with the Independent criterion.
        When scanning for criteria violations you prioritize recall, meaning that it is better to include a violation you are uncertain about than potentially missing an actual violation.
        Independent criterion: User stories should not overlap in concept and should be schedulable and implementable in any order.
        There are several types of dependency such as 'Causality', when one user story needs to be completed before another can be started or 'Superclass', when a set of user stories are specifications of another overarching user story.
        For any type of dependecy clearly state the type of dependency relation in the reason field of the output. The story that is depended upon, should be put in the 'Dependee' field.
        If one or more user stories violate the Independent criterion explain why they violate it and add them to the output, otherwise do not include them in the output.
        ...
        reason = "a string motivating why the criterion is violated"(Use formulations such as 'may be' violated expressing that these are potential violations and not facts) ,
        dependee = The user story that the stories in user_stories_subset depend on
        user_stories_subset = [a list of user stories objects that violate the Independent criterion ]
        },
        ...
        ]
        ...
        ''',
                'Complete': '''
        You are an expert requirements engineer evaluating a set of user stories for compliance with the Complete criterion.
        When scanning for criteria violations you prioritize recall, meaning that it is better to include a violation you are uncertain about than potentially missing an actual violation.
        Complete criterion: A set of user stories is complete if no user story is missing that is crucial for the development of any of the user stories in the given set.
        If one or more user stories depend on a functionality that is not mentioned in any other user story, the criterion is violated.
        If one or more user stories violate the Complete criterion explain why they violate it, in particular what major functionality is missing, and add them to the output, otherwise do not include them in the output.
        ...
        reason = "a string motivating why the criterion is violated"(Use formulations such as 'may be' violated expressing that these are potential violations and not facts) ,
        user_stories_subset = [a list of user stories objects that violate the Complete criterion ]
        },
        ...
        ]
